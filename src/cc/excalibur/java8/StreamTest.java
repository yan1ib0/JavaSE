...
//           找出2011年的所有交易并按交易额排序（从低到高）
        ...
        System.out.println("-------------------------------");
//          交易员都在哪些不同的城市工作过
        List<String>  trCity=transactions
                .stream()
                .map(transaction -> transaction.getTrader().getCity())
                .distinct()
                .toList();
        trCity.parallelStream().forEach(System.out::println);
        System.out.println("-------------------------------");
//        查找所有来自于剑桥的交易员，并按姓名排序
        List<Trader> trCambridge=transactions
                .stream()
                ...
                .toList();
        trCambridge.parallelStream().forEach(System.out::println);
        System.out.println("-------------------------------");
        //    返回所有交易员的姓名字符串，按字母顺序排序
        String traders=transactions
                .stream()
